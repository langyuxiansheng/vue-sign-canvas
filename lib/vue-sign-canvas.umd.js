(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-sign-canvas"] = factory();
	else
		root["vue-sign-canvas"] = factory();
...
// CONCATENATED MODULE: ./packages/SignCanvas/src/main.vue?vue&type=template&id=1b72171a&
  ...
  methods: {
    ...
    canvasClear: function canvasClear() {
      ...
      if (this.config.isShowBorder && !this.config.isSign) {
        this.context.beginPath();
        var size = this.config.borderWidth / 2; //画外面的框
...
//# sourceMappingURL=vue-sign-canvas.umd.js.map