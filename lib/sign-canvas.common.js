...
// CONCATENATED MODULE: ./packages/SignCanvas/src/main.vue?vue&type=template&id=e3d6457c&
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      value: null,
      //base64
      domId: "sign-canvas-".concat(Date.parse(new Date())),
      //生成唯一dom标识
      canvas: null,
      //canvas dom对象
      context: null,
  ...
  methods: {
    ...
    bindEvent: function bindEvent() {
      ...
      this.canvas.addEventListener('touchstart', function (e) {
        ...
        var getBCR = touch.target.getBoundingClientRect();
        var x = touch.pageX ? touch.pageX - getBCR.left : touch.clientX;
        var y = touch.pageY ? touch.pageY - getBCR.top : touch.clientY;
